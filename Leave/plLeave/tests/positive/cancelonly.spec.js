...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'کد کاربری:' }).fill('zohre3');
  await page.getByRole('textbox', { name: 'از تاریخ:' }).fill('2025-02-02');
  await page.getByRole('textbox', { name: 'تا تاریخ:' }).fill('2026-02-01');
